# Data Governance Framework: Thailand
...
- [<span class="toc-section-number">4</span> Country
  ...
  - [<span class="toc-section-number">4.2</span> Increasing
    ...
    - [<span class="toc-section-number">4.2.2</span> Open standards and
      software](#open-standards-and-software)
  - [<span class="toc-section-number">4.3</span> Decreasing
    ...
    - [<span class="toc-section-number">4.3.3</span> Intellectual
      property law and data](#intellectual-property-law-and-data)
  - [<span class="toc-section-number">4.4</span> Learnings](#learnings)
    - [<span class="toc-section-number">4.4.1</span> Policy frictions
      and trade-offs](#policy-frictions-and-trade-offs)
    - [<span class="toc-section-number">4.4.2</span> Good practices and
      potential learnings](#good-practices-and-potential-learnings)
    - [<span class="toc-section-number">4.4.3</span> Policy development
      and capacity
      challenges](#policy-development-and-capacity-challenges)
- [<span class="toc-section-number">5</span> Sectoral deep
  dives](#sectoral-deep-dives)
  - [<span class="toc-section-number">5.1</span> Data governance in the
    national public health
    sector](#data-governance-in-the-national-public-health-sector)
    - [<span class="toc-section-number">5.1.1</span> Laws and
      policies](#laws-and-policies)
    - [<span class="toc-section-number">5.1.2</span> Policy gaps and
      frictions](#policy-gaps-and-frictions)
    - [<span class="toc-section-number">5.1.3</span> Policy objectives,
      trade-offs, and their
      recognition](#policy-objectives-trade-offs-and-their-recognition)
    - [<span class="toc-section-number">5.1.4</span> Good practices and
      potential learnings](#good-practices-and-potential-learnings-1)
    - [<span class="toc-section-number">5.1.5</span> Policy development
      and capacity
      challenges](#policy-development-and-capacity-challenges-1)
  - [<span class="toc-section-number">5.2</span> Data governance in the
...
- [<span class="toc-section-number">6</span> Summary of
  ...
  - [<span class="toc-section-number">6.4</span> Innovations in data
    governance regimes](#innovations-in-data-governance-regimes)
  - [<span class="toc-section-number">6.5</span> Policy development
...
with those of the Western world.[^3] The 2017 Thai Constitution is the
...
officially, they lack binding legal authority.[^4]
...
changes brought by the digital age.[^5] As regards legal infrastructure
in relation to the ICT, the National Electronics and Computer Technology
...
protection, and computer crime.[^6]
...
of Chavalit Yongchaiyudh.[^7] It can be regarded as an important law in
...
effectively.[^8] It should be noted that the right to access to public
...
DPASDA.[^9] The 2020 Announcement was arguably the first policy that
...
of significant political unrest in modern Thai history.[^12] The Black
...
2014 coup)[^17] to make a national masterplan on long-term overall
national development.[^18] The junta announced the 20-Year National
Strategy, which requires all succeeding governments to adhere to the
agendas therein from 2018 to 2037.[^19] The National Strategy’s Agenda 6
on Public Sector Rebalancing and Development[^20] was translated into
...
(2020-2022).[^27] As mentioned above, the DGDC issued the Announcement
...
official information. It also has a power to issue relevant regulations,
guidelines, measures, and practices.[^28]

The OIA is guided by the idea that “disclosure is the principle; secrecy
is the exception”.[^29] Notably, just 10% of government-held public
...
Government Data Catalog Guideline Version 2, government data is
classified into five categories: Open, Private, Confidential, Secret,
and Top Secret. The last three categories align with those defined by
the OIA and by the Official Information Commission regarding government
secrecy, in order to avoid confusion with the Commission’s existing
practices. However, it is important to note that the Government Data
Catalog Guideline Version 2 currently available online is marked as a
draft.[^32] The grounds of exception include national security, public
...
Additionally, data sets and metadata can also be managed.”[^37] [^38]
...
users and 14,920,495 downloads as of 9 October 2023.[^39]

The National Statistical Office of Thailand (NSO) also plays a crucial
role in the country’s data governance framework.[^40] Under Section 6 of
the Statistics Act B.E. 2550 (2007), the NSO is responsible for
preparing, collecting, and creating national statistics.[^41]
...
directory services.[^42] These statistics are then made publicly
...
include.[^43] It specifies that a government agency website should
...
Innovation.[^45] Thailand also has an academic journal database, Thai
...
Thonburi.[^46] With regard to geo-informatics, the Ministry of Natural
...
request, which accounts for 90% of all public information.[^48]
...
and Peru.[^49] With regard to open access to law and open data relating
...
proposed measure referred to in paragraph 1.”[^50] In addition, certain
...
Assessment Framework for Government Agencies 2023.[^58] Its handbook
...
on Recommendations for Writing Data Management Policies.[^59] The
...
Registration Guidelines 2023.[^60] There are two handbooks accompanying
...
organizational websites.[^61] This handbook contains information
...
use in the private sector,[^62] web navigation system, pop-ups and tool
tips, web analytic tools, naming of files and directories, hyperlinks;
[^63] and 5. Phases of Online Service Development.[^64]
...
existing open standards such as WCAG 2.0[^65]. It contains information
...
policy, and website security policy).[^66] DGA motivates agencies to
...
B.E. 2565 (APSEM) was passed.[^67] In essence, the law grants citizens
...
comply may lead to charges of neglect of duty for the responsible
government officers, as outlined in Article 157 of the Criminal Code. In
addition, the law also empowers the OPDC to monitor all government
agencies every 15 days and to report to the cabinet every two months on
those agencies that have not implemented the required measures.
...
and OpenOffice.org.[^71] In the private sector, Thailand has the
Open-Source Education and Development Association (OSEDA) which aims to
promote the study and development of open-source software.[^72]
...
specific information within their respective organizations.[^73] They
...
preservation of civil-related official secrets,[^74] the Armed Forces
Security Center is responsible for military-related secrets,[^75] and
the Special Branch Bureau of Royal Thai Police is responsible for
police-related secrets[^76] \[Section 11 of the Rule on Maintenance of
...
system in a manner likely to cause damage to the general public….”[^77]
...
panic to the general public”.[^78] It can be concluded that in Thailand,
...
instances of disinformation.[^79]
...
likely to cause injury to any person.”[^80] Section 323 focuses on
...
a manner likely to cause injury to any person.”[^81] Under Section 324,
...
other person.”[^82] Section 325 makes the aforementioned offences
...
Protection.[^83] This guideline applies only to government agencies. In
...
2019.[^84] However, due to concerns that the public and private data
...
2022.[^85] According to the Thai government, the postponement of the
...
personal data[^86] .[^87] As with other countries’ personal data
protection laws, the PDPA stipulates that personal data cannot be
collected, processed, used, or disclosed without the data subject’s
consent. However, it should be noted that Section 4 provides exceptions
to the applicability of the PDPA.[^88] This means that in certain
circumstances personal data can be lawfully collected, processed, and
...
response to consent revocation[^89] It should be noted, however, that
...
2562 in 2023,[^90] the data controller and data processor who have
...
Abroad.[^91] Section 5 of the announcement requires the Personal Data
...
sectors.[^92] Legally speaking, all requirements prescribed under the
...
from disclosure under the Act.[^96] Nonetheless, according to the last
...
disclosure of data to the public.[^97]
...
in a location easily accessible”.[^98]
...
creator.[^99] Nevertheless, the DIP and the Central Intellectual
...
unique characteristics that differ from the original..[^100]
...
health, especially data security (Health CIRT).[^101] It also announced
...
personnel.[^102] At the national level, in September of the same year,
...
treatments across different health-care providers.[^103] This was
...
health.[^104] The document mentions that one of the aims is to increase
...
of the public and private healthcare sectors respectively.[^105]
...
National Health Security Office (Thailand), Jompon
Pitaksantayothin[^107]\].[^108]
...
on Data Governance[^109] with an aim to promote the effective use of
...
plans to tackle cyber threats, was also issued in the same year.[^110]
...
under good data governance and the principle of secret protection.[^111]
...
Secrets (No.2) B.E. 2561 (2018) and the PDPA.[^113] However, as a
...
B.E. 2551 (2008)[^114] and the Credit Information Business Act B.E. 2545
(2002)[^115] – certain organizations, such as the National Credit
Bureau,[^116] are not allowed to disclose or share financial information
with other government agencies.[^117] Secondly, although BoT is subject
...
of \[personal data\].”[^120] However, there are no detailed criteria or
...
<div id="ref-royalgazetteAnnouncementDigital2020" class="csl-entry">

Announcement of Digital Government Committee on Data Governance (2020).
<https://www.ratchakitcha.soc.go.th/DATA/PDF/2563/E/074/T_0047.PDF>.
...
<div id="ref-royalgazetteAnnouncementEstablishment2023"
class="csl-entry">

Announcement: Establishment of a Data Protection Officer (DPO) Under
Section 41(2) of the Personal Data Protection Act B.E.2562 (2023).
<https://www.mdes.go.th/uploads/tinymce/source/%E0%B8%9B%E0%B8%A3%E0%B8%B0%E0%B8%81%E0%B8%B2%E0%B8%A8%20%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%88%E0%B8%B1%E0%B8%94%E0%B9%83%E0%B8%AB%E0%B9%89%E0%B8%A1%E0%B8%B5%20dpo%20%E0%B8%A1%E0%B8%B2%E0%B8%95%E0%B8%A3%E0%B8%B2%2041(2).pdf>.

</div>

<div id="ref-aphornsuvanSearchOrder2001" class="csl-entry">

Aphornsuvan, Thanet. “The Search for Order: Constitutions and Human
Rights in Thai Political History.” 2001, 1–10.
...
<div id="ref-bankofthailandOpenBanking2022" class="csl-entry">

Bank of Thailand. “Open Banking and Its Benefits for Thai People.” March
2022.
<https://www.bot.or.th/th/research-and-publications/articles-and-publications/articles/Article_11Mar2022.html>.

</div>

<div id="ref-chanataradhammaPersonalData2021" class="csl-entry">
...
<https://digital.car.chula.ac.th/cgi/viewcontent.cgi?article=8826&context=chulaetd>.
...
<div id="ref-CopyrightAct2022" class="csl-entry">

Copyright Act (No.5) B.E.2565 (2022) (2022).
<https://www.ipthailand.go.th/images/26669/2566/laws/COPYRIGHT%20ACT%20(NO.%205),2022.pdf>.

</div>

<div id="ref-CreditInformation2002" class="csl-entry">

Credit Information Business Act B.E. 2545 (2002) (2002).
<https://www.ncb.co.th/wp-content/uploads/2017/06/Creditinfo_acteng_5combined.pdf>.

</div>

<div id="ref-deputydirectorofdatamanagementandanalyticsdepartmentbankofthailand2023"
class="csl-entry">

</div>

<div id="ref-deputypermanentsecretaryoftheofficeoftheprimeministerthailand2023"
class="csl-entry">

</div>

<div id="ref-DGACommunity2023" class="csl-entry">

“DGA Community Standard GOVERNMENT DATA CATALOG GUIDELINE REVIEW.” 2023.
<https://standard.dga.or.th/wp-content/uploads/2023/06/2.-%E0%B8%AA%E0%B8%B4%E0%B9%88%E0%B8%87%E0%B8%97%E0%B8%B5%E0%B9%88%E0%B8%AA%E0%B9%88%E0%B8%87%E0%B8%A1%E0%B8%B2%E0%B8%94%E0%B9%89%E0%B8%A7%E0%B8%A21_PRD_GD-Catalog-Guideline-v.06.pdf>.
...
<div id="ref-digitalgovernmentdevelopmentagencyHistoryDigital2021"
class="csl-entry">

Digital Government Development Agency. “History of of the Digital
Government Development Plan of Thailand for the years 2020-2022.” 2021.
...
<div id="ref-digitalgovernmentdevelopmentagencyWelcomeOpen2015"
class="csl-entry">

Digital Government Development Agency. “Welcome - Open Government Data
of Thailand.” 2015. <https://data.go.th/>.

</div>

<div id="ref-directorofdigitalinformationsupportdepartmentnationalhealthsecurityofficethailand2023"
class="csl-entry">
...
<div id="ref-electronicgovernmentagencyGovernmentWebsite2021"
class="csl-entry">
...
<div id="ref-FinancialInstitutions2008" class="csl-entry">

Financial Institutions Business Act B.E.2551 (2008) (2008).
<http://web.krisdika.go.th/data/outsitedata/outsite21/file/FINANCIAL_INSTITUTIONS_BUSINESSES_ACT,_B.E.2551_(2008).pdf>.

</div>

<div id="ref-googleThailandPersonal2022" class="csl-entry">
...
<div id="ref-legalconsultantwhoisspecializedindatamanagementandprotection2023"
class="csl-entry">
...
<div id="ref-nationalscienceandtechnologydevelopmentagency13Standard"
class="csl-entry">

National Science and Technology Development Agency. “13 Standard Fonts
from Software Industry Promotion Agency (SIPA).” NSTDA. Accessed July
16, 2024. <https://www.nstda.or.th/home/news_post/thai-font/>.
...
<div id="ref-officeofthecouncilofstateLawPortal" class="csl-entry">
...
<div id="ref-officeoftheofficialinformationcommissionHistoryOffice2013"
class="csl-entry">

Office of the Official Information Commission. “History of Office of the
Official Information Commission.” 2013.
<https://www.oic.go.th/web2017/about01.htm>.

</div>

<div id="ref-officeoftheofficialinformationcommissionOfficeOfficial2013"
class="csl-entry">

Office of the Official Information Commission. “Office of the Official
Information Commission - Missions.” 2013.
<http://www.oic.go.th/web2017/mission.htm>.
...
Office of the Official Information Commission. *Summary of Key Points of
the Official Information Act B.E.2540*. 1997.
<https://www.parliament.go.th/ewtadmin/ewt/parliament_parcy/ewt_dl_link.php?nid=16575&filename=gennews_statute>.

</div>

<div id="ref-officeofthepersonaldataprotectioncommissionBenefitsPersonal"
class="csl-entry">
...
Peacebuilding* 5, no. 1 (2017): 131–54.
...
[^31]: Director of the Office of the Official Information Commission
...
[^56]: Announcement on Disclosure of Public Sector Information in
    Digital Format to the Public.
...
[^62]: National Science and Technology Development Agency, “13 Standard
    Fonts from Software Industry Promotion Agency (SIPA).”

[^63]: It is important to note that all of these should be consistent
...
[^65]: The Ministry of ICT (the former name of the Ministry of Digital
...
[^86]: Office of the Personal Data Protection Commission, “Benefits from
    the Personal Data Protection Act B.E.2562.”

[^87]: Prachachat Online, *Postponement of the Enforcement of the
    Personal Data Protection Act by Another 1 Year*.

[^88]: Section 4 This Act shall not apply to:
...
[^95]: Chanataradhamma, “Personal Data Protection Standards of Publicly
    Available Information of Tax.”

[^96]: Chanataradhamma.

[^97]: Announcement on Disclosure of Public Sector Information in
    Digital Format to the Public.
...
[^114]: Financial Institutions Business Act B.E.2551 (2008).
