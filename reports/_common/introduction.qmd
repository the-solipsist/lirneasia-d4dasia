...
::: {.content-visible when-meta="country:Philippines"}
The last part of the report consists of a deep dive examining the policy gaps and frictions in the data governance framework.
:::

::: {.content-visible when-meta="country:Thailand"}
The final section of the report provides a comprehensive examination of the policy gaps and frictions within the data governance framework. Here, we conducted a detailed analysis of two critical sectors:
